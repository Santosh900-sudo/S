...
bot = telebot.TeleBot('7422940774:AAG7nZ31r85jdLsTOPlIVU7IgrkEUNezmCU')#BGMI
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🚫 Unauthorized Access!🚫Please buy access :-@Mr_sid_001"
...
def welcome_start(message):
    ...
    response = f'''🫡WELCOME TO MR_SID DDOS BOT 🚀 '''
    bot.reply_to(message, response)
...
def welcome_rules(message):
    user_name = message.from_user.first_name
    response = f'''
1. ANY PROBLEM DM HERE -> @Mr_sid_001'''
    bot.reply_to(message, response)
